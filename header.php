...
<body>
  ...
  <header class="py-2 pb-sm-0">

    <div class="navbar navbar-expand-md navbar-light shadow-sm p-0 pb-sm-1">
      <div class="container px-1">
        ...
        <div class="col-auto text-right px-0 order-md-last">
          <h6 class="text-uppercase px-1 d-none d-lg-block">
            <?php echo get_theme_mod( 'contacts_title', 'Контакты' ); ?>
          </h6>
          
          <div class="row justify-content-center no-gutters">
            <?php if(get_theme_mod( 'contacts_phone', false )) : ?>
              <a href="tel:<?php echo preg_replace( '/[^0-9+]/', '', get_theme_mod( 'contacts_phone' ) ) ?>" class="p-1">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="btn btn-primary btn-sm p-0">
                  <path d="M0 0h24v24H0z" fill="none"></path><path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z"></path>
                </svg>
                <span class="d-none align-middle d-md-inline-block ml-1">
            ...
            <?php if(get_theme_mod( 'contacts_address', false )) : ?>
              <a <?php echo get_theme_mod( 'contacts_address_link', false ) ? 'href="' . get_theme_mod( 'contacts_address_link' ). '"' : ''; ?> class="p-1 px-sm-2">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="btn btn-danger btn-sm p-0">
                  <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"></path><path d="M0 0h24v24H0z" fill="none"></path>
                </svg><span class="ml-1 align-middle d-none d-lg-inline-block">
                  <?php echo get_theme_mod( 'contacts_address' ); ?></span>
              </a>
            <?php endif; ?>

            <?php if(get_theme_mod( 'contacts_enter_checkbox', true )) : ?>
              <a href="/wp-admin" class="p-1 px-sm-2">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="btn btn-primary btn-sm p-0">
    ...
    <div class="navbar navbar-expand-md navbar-light bg-light shadow-sm p-0 py-md-2">
